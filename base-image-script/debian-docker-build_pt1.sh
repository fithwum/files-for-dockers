...
if [ -e /debian-docker-build_pt2.sh ]
	then
		...
		echo "WARNING ! debian-docker-build_pt2.sh not found ... will download new copy."
			wget --no-cache https://raw.githubusercontent.com/fithwum/files-for-dockers/refs/heads/master/base-image-script/debian-docker-build_pt2.sh -O /debian-docker-build_pt2.sh
...
if [ -e /debian-docker-build_pt3.sh ]
	then
		...
		echo "WARNING ! debian-docker-build_pt3.sh not found ... will download new copy."
			wget --no-cache https://raw.githubusercontent.com/fithwum/files-for-dockers/refs/heads/master/base-image-script/debian-docker-build_pt3.sh -O /debian-docker-build_pt3.sh
